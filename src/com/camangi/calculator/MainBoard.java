...
//        mPanelSwitcher = (PanelSwitcher) findViewById(R.id.panelswitch);
        ...
        mLogic = new Logic(this, mDisplay, (Button) findViewById(R.id.equal_button));
        View view;
...
//        }
        ...
        if ((view = findViewById(R.id.factorial)) != null) {
            view.setOnClickListener(mListener);
        }
        if ((view = findViewById(R.id.leftParen)) != null) {
            view.setOnClickListener(mListener);
        }
        if ((view = findViewById(R.id.rightParen)) != null) {
            view.setOnClickListener(mListener);
        }
        if ((view = findViewById(R.id.c_button)) != null) {
            view.setOnClickListener(mListener);
        }
        if ((view = findViewById(R.id.ac_button)) != null) {
            view.setOnClickListener(mListener);
        }
        ...
        if ((view = findViewById(R.id.sin)) != null) {
            view.setOnClickListener(mListener);
        }
        if ((view = findViewById(R.id.cos)) != null) {
            view.setOnClickListener(mListener);
        }
        if ((view = findViewById(R.id.tan)) != null) {
            view.setOnClickListener(mListener);
        }
        if ((view = findViewById(R.id.ln)) != null) {
            view.setOnClickListener(mListener);
        }
        if ((view = findViewById(R.id.lg)) != null) {
            view.setOnClickListener(mListener);
        }
        ...
        if ((view = findViewById(R.id.digit7)) != null) {
            view.setOnClickListener(mListener);
        }
        if ((view = findViewById(R.id.digit8)) != null) {
            view.setOnClickListener(mListener);
        }
        if ((view = findViewById(R.id.digit9)) != null) {
            view.setOnClickListener(mListener);
        }
        if ((view = findViewById(R.id.div)) != null) {
            view.setOnClickListener(mListener);
        }
        if ((view = findViewById(R.id.pi)) != null) {
            view.setOnClickListener(mListener);
        }
        
        
        
        if ((view = findViewById(R.id.digit4)) != null) {
            view.setOnClickListener(mListener);
        }
        if ((view = findViewById(R.id.digit5)) != null) {
            view.setOnClickListener(mListener);
        }
        if ((view = findViewById(R.id.digit6)) != null) {
            view.setOnClickListener(mListener);
        }
        if ((view = findViewById(R.id.mul)) != null) {
            view.setOnClickListener(mListener);
        }
        if ((view = findViewById(R.id.e)) != null) {
            view.setOnClickListener(mListener);
        }
        ...
        if ((view = findViewById(R.id.digit1)) != null) {
            view.setOnClickListener(mListener);
        }
        if ((view = findViewById(R.id.digit2)) != null) {
            view.setOnClickListener(mListener);
        }
        if ((view = findViewById(R.id.digit3)) != null) {
            view.setOnClickListener(mListener);
        }
        if ((view = findViewById(R.id.minus)) != null) {
            view.setOnClickListener(mListener);
        }
        if ((view = findViewById(R.id.power)) != null) {
            view.setOnClickListener(mListener);
        }
        ...
        if ((view = findViewById(R.id.digit0)) != null) {
            view.setOnClickListener(mListener);
        }  
        if ((view = findViewById(R.id.dot)) != null) {
            view.setOnClickListener(mListener);
        }
        if ((view = findViewById(R.id.equal_button)) != null) {
            view.setOnClickListener(mListener);
        }
        if ((view = findViewById(R.id.plus)) != null) {
            view.setOnClickListener(mListener);
        }
        if ((view = findViewById(R.id.sqrt)) != null) {
            view.setOnClickListener(mListener);
        }
